...
A master catalog and navigation hub for all 8 specialized **Kirby PLR Skills** designed for the Google Antigravity, Claude Code, Cursor, and Windsurf agent ecosystems.
...
| 2 | [**kirby-audience-intel-profiler**](https://github.com/markkirby125/kirby-audience-intel-profiler) | Profiling | `audience-intel`, `buyer-persona` | Extracts subniche jargon, operational friction, and taboo buzzwords to ground AI content in buyer reality. |
| 3 | [**kirby-storyline-bank**](https://github.com/markkirby125/kirby-storyline-bank) | Storytelling | `story-bank`, `business-scar` | Extracts, structures, and catalogs personal business scars and epiphanies for authentic storytelling. |
| 4 | [**kirby-plr-personalizer**](https://github.com/markkirby125/kirby-plr-personalizer) | Execution | `personalize-plr`, `framework-fusion` | Master Two-Way PLR Personalization & Framework Fusion engine for AI agents. |
| 5 | [**kirby-plr-email-sequences**](https://github.com/markkirby125/kirby-plr-email-sequences) | Repurposing | `plr-emails`, `autoresponder` | Converts raw informational PLR into high-converting direct-response email autoresponder sequences. |
